...
def run_ad_design_app():
    ...
    if uploaded is not None:
        ...
        st.markdown("""
        **Short Interpretaion information:**
        - High Text Density → risk on clutter
        - Low Contrast → Hard to read Ads
        - Inconsistent Aligntment → Bad Visual Experience
        - CTA Detected → More Effectiveness
        """)
